...
function createPointTemplate({ point, pointDestination, pointOffers }) {
  ...
  function createOfferTemplate() {
    return (
      pointOffers.map((offer) => (
        point.offers.find((id) => id === offer.id) === offer.id ?
  ...
  return (
    ...
    <div class="event">
      ...
      ${formatStringToShotrDate(dateFrom)}
      </time>
      ...
      <div class="event__schedule">
        <p class="event__time">
          ...
          datetime="${formatStringToTime(dateFrom)}">
          ${formatStringToTime(dateFrom)}
          </time>
          &mdash;
          <time class="event__end-time" datetime="formatStringToTime(dateTo)">
